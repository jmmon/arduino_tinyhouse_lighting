void updateLightsDEBUG(uint8_t ii) {
    ...
    Serial.print(F(" Master brightness: ")); Serial.print(section[ii].masterLevel);
...
void heldActionsDEBUG(uint8_t ii, uint8_t bb, uint16_t s) {
    Serial.print(F(" section:")); Serial.print(ii);
    Serial.print(F(" pin:")); Serial.print(section[ii].PIN);
    Serial.print(F(" ")); Serial.print(s); // buttonStatus
    Serial.print(F(" | "));
